  ...
  <?php
    ...
    while($data = mysqli_fetch_array($query)){
        ...
        <input id="nama_lengkap" name="nama_lengkap" type="text" class="form-control" placeholder="nama_lengkap" value="<?php echo $data['nama_lengkap']; ?>" readonly>
               ...
               <div class="form-group has-feedback">
        <label>Email</label>
        <input id="email" name="email" type="text" class="form-control" placeholder="email" value="<?php echo $data['email']; ?>" readonly>
       
              </div>

                <div class="form-group has-feedback">
        <label>Username</label>
        <input id="username" name="username" type="text" class="form-control" placeholder="username" value="<?php echo $data['username']; ?>" readonly>
       
              </div>
                   <div class="form-group has-feedback">
        <label>Hp</label>
        <input id="hp" name="hp" type="text" class="form-control" placeholder="hp" value="<?php echo $data['hp']; ?>" readonly>
       
              </div>
            <div class="form-group has-feedback">
        <label>Password</label>
        <input id="password" name="password" type="text" class="form-control" placeholder="" value="" readonly>
...
<!-- <div class="form-group has-feedback">
       <hiden  id="email" name="email" type="text" value="$_SESSION['email'];" > 
        ...
        <div class="form-feedback">
           ...
           <a href="editakun.php" class="btn btn-primary btn-block btn-flat">Edit Akun</a>
        </div>
