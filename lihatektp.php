...
?></a>
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                                <a href="http://www.dispendukcapil.semarangkota.go.id"><i class="icon-worldwide"></i> <span>www.dispendukcapil.semarangkota.go.id</span></a>
                            </div>
                        </div>
                    </nav>
                </div>
  ...
  <div class="top-popular-courses-area mt-50 section-padding-100-70">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center mx-auto wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <span>Silahkan Pilih nik yang belum terdaftar</span>
         ...
         <div class="single-hero-slide bg-img" style="background-image: url(blangko.jpg);">
                <div class="container h-100">
                        ...
                        <div class="col-12">
                            <div class="hero-slides-content" >
                              <br> <br><br><br><br><br><br><br>
                                ...
                                <h2 style="color:#FF0000;" data-animation="fadeInUp" data-delay="400ms"><br>Dinas Kependudukan<br>  Pencatatan Sipil Kota Semarang</h2>
