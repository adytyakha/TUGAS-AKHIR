...
<body>
 ...
 <td>
                                              ...
                                              <span><a target="_blank" class="btn btn-info btn-sm" onclick="return confirm(`Apakah Anda ingin kirim Email  = '.$array['email'].' ?`)"href="setting/kirimemail.php?id='.$array['id'].'& email='.$array['email'].'& hp='.$array['hp'].'  " ><i  class="fa fa-envelope-o"></i></a></span>
