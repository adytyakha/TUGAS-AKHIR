...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">HISTORI</strong>
                            </div>
 ...
 <td>
                                               ...
                                               <span><a class="btn btn-danger btn-sm" onclick="return confirm(`Apakah Anda ingin membatalkan verifikasi Id = '.$array['id'].' ?`)"href="setting/batalverifikasi.php?id='.$array['id'].'" ><i  class="fa  fa-upload"></i></a></span>
