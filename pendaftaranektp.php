...
<div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
       ...
       <div class="form-group has-feedback">
        ...
        <div class="form-group has-feedback">
        <label>POS</label>
        <input id="pos" name="pos" type="text" class="form-control" placeholder="pos" value=" <?php echo $data['pos']; ?>" readonly>
       ...
       <div class="form-group has-feedback">
        <label>Email</label>
        <input id="email" name="email" type="text" class="form-control" placeholder="Email" value="<?php echo $_SESSION['email']; ?>" readonly>
      
      </div>

       <div class="form-group has-feedback">
        <label>Hp</label>
        <input id="hp" name="hp" type="text" class="form-control" placeholder="Hp" value="<?php echo $_SESSION['hp']; ?>" readonly>
